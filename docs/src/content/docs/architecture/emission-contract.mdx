...
See also: [Illustrative .proto sketch](/examples/emission_contract.proto) for wire message shapes.
...
- Proto sketch (download): [/examples/emission_contract.proto](/examples/emission_contract.proto)
